-- Step-by-Step Database Fix for InnoCanvas
-- Run this SQL in your Supabase SQL editor to fix all missing columns and tables
...
-- ============================================================================
-- STEP 2: INSERT DEFAULT PLAN DATA
-- ============================================================================
...
-- ============================================================================
-- STEP 4: ADD MISSING COLUMNS TO CANVASES TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 8: CREATE FUNCTIONS (SIMPLIFIED)
-- ============================================================================
...
BEGIN
  RAISE NOTICE '=========================================';
  RAISE NOTICE 'InnoCanvas Database Fix Complete!';
  RAISE NOTICE '=========================================';
  RAISE NOTICE '';
  RAISE NOTICE 'All missing columns and tables have been added:';
  RAISE NOTICE '- ✅ plan_limits table created';
  RAISE NOTICE '- ✅ subscriptions table created';
  RAISE NOTICE '- ✅ All profile columns added (plan, plan_expiry, etc.)';
  RAISE NOTICE '- ✅ All canvas columns added (tags, title, etc.)';
  RAISE NOTICE '- ✅ Indexes created for performance';
  RAISE NOTICE '- ✅ RLS policies configured';
  RAISE NOTICE '- ✅ Functions and triggers created';
  RAISE NOTICE '';
  RAISE NOTICE 'Next steps:';
  RAISE NOTICE '1. Create "logos" and "avatars" storage buckets';
  RAISE NOTICE '2. Run storage policies from storage-policies.sql';
  RAISE NOTICE '';
  RAISE NOTICE 'Database is now fully configured!';
END $$;
